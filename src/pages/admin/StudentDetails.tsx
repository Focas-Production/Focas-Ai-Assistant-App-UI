...
const AdminSidebar: React.FC = () => (
  <div className="bg-[#120088] text-white w-60 h-screen flex flex-col justify-between fixed font-poppins">
    ...
    <nav className="flex flex-col gap-2 text-[16px] mt-[-600px]">
      ...
      <a href="/admin/student-details" className="flex items-center gap-3 px-6 py-3 font-semibold bg-white text-[#120088] border-l-4 border-green-400">
  ...
  return (
    <div className="flex h-screen bg-[#f7f9fc]">
      ...
      <div className="flex-1 ml-60 flex flex-col relative">
        ...
        {/* Heading */}
        <div className="w-full max-w-3xl mt-8 text-[#120088] text-xl font-bold">Student’s List:</div>
        {/* Table */}
